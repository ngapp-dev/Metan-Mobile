package com.ngapp.metanmobile.presentation.settings.view.legalregulations.privacypolicy.view
...
const val privacyPolicy = "<!DOCTYPE html>\n" +
        ...
        "</head>\n" +
        "<body>\n" +
        "<p>NGApps Dev built the Metan Mobile app as a Free app. This SERVICE is provided by NGApps Dev at no cost and is intended for use as is.</p>\n" +
        "<p>This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.</p>\n" +
        "<p>If you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.</p>\n" +
        "<p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at Metan Mobile unless otherwise defined in this Privacy Policy.</p>\n" +
        ...
        "<p>This policy is effective as of 2023-03-07</p>\n" +
        "<p><strong>Contact Us</strong></p>\n" +
        "<p>If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at hypnogaja93@gmail.com.</p>\n" +
