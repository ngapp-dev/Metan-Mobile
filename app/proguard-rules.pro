...
-keep class com.ngapp.metanmobile.data.model.** { *; }
-keepclasseswithmembers class com.ngapp.metanmobile.data.model.** { *; }
#-keep class com.ngapp.metanmobile.** { *; }
#-keepclasseswithmembers class com.ngapp.metanmobile.** { *; }